...
#define SWIG_name      "functions"
#define SWIG_init      luaopen_functions
#define SWIG_init_user luaopen_functions_user

#define SWIG_LUACODE   luaopen_functions_luacode
...
extern "C" {
#endif
static int _wrap_testfunc(lua_State* L) {
  int SWIG_arg = 0;
  
  SWIG_check_num_args("testfunc",0,0)
  testfunc();
...
static int _wrap_get2(lua_State* L) {
  int SWIG_arg = 0;
  int result;
  
  SWIG_check_num_args("get2",0,0)
  result = (int)get2();
